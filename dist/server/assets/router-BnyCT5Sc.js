...
const appCss = "/assets/styles-DSLZtCBT.css";
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Premium fintech console for issuing official electricity payment receipts across UP DISCOMs with instant PDF download."
      },
      { name: "author", content: "RanaPay India Pvt. Ltd." },
      { property: "og:title", content: "RanaPay — Electricity Payment Receipts Console" },
      {
        property: "og:description",
        content: "Generate pixel-perfect electricity payment receipts with dynamic DISCOM logos and instant PDF export."
      },
...
const $$splitComponentImporter$3 = () => import("./_app-D0N8uMBu.js");
const Route$3 = createFileRoute("/_app")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-SU9FPd6O.js");
const Route$2 = createFileRoute("/_app/")({
  head: () => ({
    meta: [{
      title: "Dashboard — RanaPay Receipts Console"
    }, {
      name: "description",
      content: "Premium fintech dashboard for generating official electricity payment receipts across DVVNL, PVVNL, PuVVNL, KESCO and MVVNL."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./history-C8VTAZBw.js");
const Route$1 = createFileRoute("/_app/history")({
  head: () => ({
    meta: [{
      title: "Receipt History — RanaPay Console"
    }, {
      name: "description",
      content: "Search, view and download every electricity payment receipt issued through RanaPay."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./create-DaQQLynP.js");
const Route2 = createFileRoute("/_app/create")({
  head: () => ({
    meta: [{
      title: "Create Receipt — RanaPay Console"
    }, {
      name: "description",
      content: "Create a new electricity payment receipt with auto-generated receipt number, dynamic DISCOM mapping and instant PDF download."
    }]
  }),
...
const AppIndexRoute = Route$2.update({
  id: "/",
  path: "/",
  getParentRoute: () => AppRoute
});
const AppHistoryRoute = Route$1.update({
  id: "/history",
  path: "/history",
  getParentRoute: () => AppRoute
});
const AppCreateRoute = Route2.update({
  id: "/create",
  path: "/create",
  getParentRoute: () => AppRoute
});

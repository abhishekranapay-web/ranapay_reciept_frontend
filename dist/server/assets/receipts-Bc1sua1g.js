import { c as createLucideIcon, a as cn } from "./button-D0H4hbJg.js";
...
function generateReceiptNo() {
  const datePart = format(/* @__PURE__ */ new Date(), "yyyyMMdd");
...
const DISCOM_KEYS = Object.keys(DISCOMS);
const CONNECTION_TYPES = ["POSTPAID", "PREPAID"];
const AREAS = ["RURAL", "URBAN", "IPDS", "RAPDRP"];
const PAYMENT_MODES = ["PG", "WALLET"];
const AGENCY_NAME = "RANAPAY INDIA PRIVATE LIMITED";
const RANAPAY_LOGO = "/logos/ranapay.png";
const seed = [
  {
    ...
    paymentDate: new Date(Date.now() - 864e5 * 2).toISOString(),
    paymentMode: "PG",
  ...
  },
  {
    ...
    agentId: "AG10078",
    transactionStatus: "SUCCESS",
    paymentDate: new Date(Date.now() - 864e5).toISOString(),
    paymentMode: "WALLET",
    agencyName: AGENCY_NAME,
    paymentStatus: "SUCCESS",
...
export {
  ...
  DISCOMS as b,
  CircleCheck as c,
  CONNECTION_TYPES as d,
  amountToWords as e,
  format as f,
  AGENCY_NAME as g,
  useReceiptStore as u
};
